...
st.markdown("<p style='text-align: center; font-weight: bold; font-size: 16px;'>Aplicación para la toma de decisiones en cálculos de Hidráulica Operativa y Dosificación de Espuma</p>", unsafe_allow_html=True)
